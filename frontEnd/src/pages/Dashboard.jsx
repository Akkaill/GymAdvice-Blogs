      ...
      <main className="flex-1 p-8 space-y-10">
        ...
        {user.role === "superadmin" && (
          <>
            ...
            >
              <h2 className="text-2xl font-bold text-blue-300 pb-3">
                User Management
              </h2>
              {loadingUsers ? (
                <Spinner />
              ...
              >
                <h3 className="text-xl font-semibold mb-3 text-purple-300 pb-3">
                  Create New Admin
                </h3>
          ...
          {loadingLogs ? (
            ...
            <div className="max-h-[400px] overflow-y-auto rounded-lg border border-gray-700">
              <table className="w-full text-left table-auto text-white">
                <thead>
                  <tr className="text-gray-400 border-b border-gray-700 sticky top-0 bg-[#22252a]">
